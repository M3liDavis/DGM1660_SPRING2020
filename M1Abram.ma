...
//Name: M1Abram.ma
//Last modified: Sat, Feb 15, 2020 10:29:55 PM
//Codeset: 1252
requires maya "2020";
requires "mtoa" "4.0.0";
...
fileInfo "UUID" "475C6BC1-4C76-6FC1-06CF-2D9183612510";
fileInfo "license" "student";
createNode transform -s -n "persp";
	rename -uid "664D428F-4716-20E6-D6A8-15A046F91E2E";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.87183077773928375 2.0452747650499603 25.926552148111945 ;
	setAttr ".r" -type "double3" 2.0616472708714597 -345.79999999999762 1.0252494769972003e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "E406B2FF-4D09-D764-21EB-0FAD74648789";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 20.206919596261354;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -4.0818672320341651 2.7722140238128259 6.3497282251190938 ;
...
createNode transform -s -n "side";
	...
	setAttr ".t" -type "double3" 1000.1 2.7490809811066721 7.5534466569426995 ;
...
createNode mesh -n "pCubeShape2" -p "pCube2";
	...
	setAttr ".pt[40]" -type "float3" 0 0 2.3841858e-07 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "C6B8F681-40BD-A43C-918E-B0ACA0646D19";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "7AA9B741-428F-541A-58F4-66BE1CB2A622";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "C45D6821-44DA-3537-36C0-9595AD85B510";
createNode displayLayerManager -n "layerManager";
	rename -uid "E9CEC202-4A32-D952-BB3F-BBAA7A50AC92";
	setAttr ".cdl" 1;
	setAttr ".dli[1]"  1;
createNode displayLayer -n "defaultLayer";
	rename -uid "B05C0F14-4956-DC6F-5B0F-058809746880";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "B3148359-4FB9-212A-166E-64ACFF9B7E95";

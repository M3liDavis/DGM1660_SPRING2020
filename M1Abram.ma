...
//Name: M1Abram.ma
//Last modified: Tue, Feb 11, 2020 11:36:21 AM
//Codeset: 1252
requires maya "2020";
requires "mtoa" "4.0.0";
...
fileInfo "UUID" "AA6C0521-44C1-04F1-E870-4486F45AB072";
fileInfo "license" "student";
createNode transform -s -n "persp";
	rename -uid "664D428F-4716-20E6-D6A8-15A046F91E2E";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 13.460974517456849 0.6210285407870435 3.0666746284452771 ;
	setAttr ".r" -type "double3" 6.861647270847314 -259.40000000025753 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "E406B2FF-4D09-D764-21EB-0FAD74648789";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 17.976154970443158;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -4.0818672320341651 2.768680736814976 6.3497282251190938 ;
...
createNode transform -s -n "front";
	...
	setAttr ".t" -type "double3" -3.5924164242145227 2.6459306472818813 1000.1 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "7E38BBA2-4E15-7F15-C970-D0980D4CEB89";
	setAttr -k off ".v";
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1;
	setAttr ".ow" 17.310531912461137;
...
createNode transform -s -n "side";
	...
	setAttr ".t" -type "double3" 1000.1 2.7156835796874508 -0.25220426441368637 ;
...
createNode transform -n "pCube1";
	...
	setAttr ".t" -type "double3" 0 2.3670560844680617 0.051414098400369923 ;
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr -s 38 ".pt[0:37]" -type "float3"  0.44478208 0 0 -0.44478208 
		...
		0.036423683 -0.87416846 0.44478208 0.018211843 -1.2839351 -0.44478208 0.018211843 
		-1.2839351 -0.44478208 0.036423706 -1.283935 0.44478208 0.036423706 -1.283935 0.44478208 
		0.02731777 -3.7047098 -0.44478208 0.02731777 -3.7047098 -0.44478208 0.75579154 -3.6864979 
		0.44478208 0.75579154 -3.6864979;
...
createNode transform -n "pCube2";
	...
	setAttr ".t" -type "double3" -4.0818673757475858 2.8769446917913295 5.8497282251190938 ;
	setAttr ".s" -type "double3" 4.8222221913167873 0.73333333548952728 1 ;
...
createNode transform -n "pCube3";
	...
	setAttr ".t" -type "double3" -8.1193666278457428 2.3670560844680617 0.051414098400369923 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "5611F45F-40FE-F93D-BBEC-6780B8FC3C5C";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "2622B17E-46E0-D268-49B0-F497D3F2E85A";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "EAEEABB4-4F8D-EF87-90CA-D5AD2C9D7B17";
createNode displayLayerManager -n "layerManager";
	rename -uid "22301003-454D-D145-E5F1-FAAB72C813B3";
createNode displayLayer -n "defaultLayer";
	rename -uid "B05C0F14-4956-DC6F-5B0F-058809746880";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "378D4614-4463-6397-A39B-AB9945EB7A6B";
...
createNode polyTweak -n "polyTweak3";
	...
	setAttr ".uopa" yes;
	setAttr -s 10 ".tk";
	setAttr ".tk[8]" -type "float3" -0.0092007816 0 0 ;
	setAttr ".tk[9]" -type "float3" -0.0092007816 0 0 ;
	setAttr ".tk[10]" -type "float3" -0.0092007816 0 0 ;
	setAttr ".tk[11]" -type "float3" -0.0092007816 0 0 ;
	setAttr ".tk[12]" -type "float3" 0.0092007816 0 0 ;
	setAttr ".tk[13]" -type "float3" 0.0092007816 0 0 ;
	setAttr ".tk[14]" -type "float3" 0.0092007816 0 0 ;
	setAttr ".tk[15]" -type "float3" 0.0092007816 0 0 ;

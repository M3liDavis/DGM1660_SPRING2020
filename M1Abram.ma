...
//Name: M1Abram.ma
//Last modified: Thu, Feb 13, 2020 08:41:57 PM
//Codeset: 1252
requires maya "2020";
requires "mtoa" "4.0.0";
...
fileInfo "UUID" "46CEDFE2-4610-6515-C9E2-21B9E2951224";
fileInfo "license" "student";
createNode transform -s -n "persp";
	rename -uid "664D428F-4716-20E6-D6A8-15A046F91E2E";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 8.4948524113160939 12.418270985937259 27.216402568672574 ;
	setAttr ".r" -type "double3" -19.538352729137078 -333.80000000013655 1.7723739275980297e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "E406B2FF-4D09-D764-21EB-0FAD74648789";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 30.226469777267948;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -4.0818675194610066 2.3093978059037399 1.6571327432465353 ;
...
createNode mesh -n "pCubeShape2" -p "pCube2";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 2 ".pt[0:1]" -type "float3"  0 -1.1920929e-07 0 0 -1.1920929e-07 
		0;
	setAttr ".ai_translator" -type "string" "polymesh";
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "B408FDB9-4D25-9FDA-5853-5F9BA7D2C699";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "C2C4AF3B-41DA-DA99-3E67-61B7E56518D6";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "F7ED89DE-47E5-4156-0069-B7A203D3FFA3";
createNode displayLayerManager -n "layerManager";
	rename -uid "BA89891F-44A4-AB13-80FC-76BC266F4ED5";
createNode displayLayer -n "defaultLayer";
	rename -uid "B05C0F14-4956-DC6F-5B0F-058809746880";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "48DD4559-463D-6BFD-286C-F8AF41B4022C";
